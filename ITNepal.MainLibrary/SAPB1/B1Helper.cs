...
namespace ITNepal.MainLibrary.SAPB1
{
    public class B1Helper
    {
        ...
        public static void RemoveField(string Table ,int FieldID)
        {
            UserFieldsMD oUsf = (UserFieldsMD)B1Helper.diCompany.GetBusinessObject(BoObjectTypes.oUserFields);
             oUsf.GetByKey(Table, FieldID);
             oUsf.Remove();
        }
