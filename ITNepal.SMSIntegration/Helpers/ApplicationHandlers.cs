...
using ITNepal.SMSIntegration.Forms;
    ...
    public class ApplicationHandlers
    {
        ...
        private void SBO_Application_MenuEventBefore(ref SAPbouiCOM.MenuEvent pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                ...
                switch (pVal.MenuUID)
                {
                    case  "SMS Details Setup":
                        SMS_Details_Setup activeForm = new SMS_Details_Setup();
                        activeForm.Show();
                        break;
                    //case "Gate Pass":
                    ...
                    //    ShipmentTracking activeForm1 = new ShipmentTracking();
                    //    activeForm1.Show();
                    //    break;
                    //case "Letter of Credit":
                    //    Letter_of_Credit activeForm2 = new Letter_of_Credit();
                    //    activeForm2.Show();
                    //    break;
                    //case "Provisional Cost":
                    //    Provisional_Cost activeForm3 = new Provisional_Cost();
                    //    activeForm3.Show();
                    //    break;
                    //case "Landed Cost Details Report":
                    //    LandedCostDetailReport activeForm4 = new LandedCostDetailReport();
                    //    activeForm4.Show();
                    //    break;
                    //      case "Auto Item Master Code Setup":
                    //    AITCDM aitcdm = new AITCDM();
                    //    aitcdm.Show();
                    //    break;
                    //case "Item_Code_Logic_Setup":
                    //    Item_Code_Logic_Setup iclc = new Item_Code_Logic_Setup();
                    //    iclc.Show();
                        //break;
                }
                //if (activeForm != null)
