...
namespace ITNepal.SMSIntegration.Helpers
{
    public class AddonInfoInfo
    {
        ...
        public static void CreateUDOForms()
        {
            try
            {
                ...
                B1Helper.AddField("ITN_VHNO", "RV Number", "ORCT", BoFieldTypes.db_Alpha, 50, BoYesNoEnum.tYES, BoFldSubTypes.st_None, true, "");
                #endregion
        ...
        public static bool InstallUDOs()
        {
            try
            {
                ...
                string[] FindColumn = new string[0];
                string[] FormColumn = new string[0];
                string[] validValue = new string[0];
               
                //////#region OADP
                //////B1Helper.AddField("ITN_SMSBODY", "SMSBODY", "ADP1", BoFieldTypes.db_Alpha, 250, BoYesNoEnum.tNO, BoFldSubTypes.st_None, false, "");
                //////B1Helper.AddField("ITN_OBJLIST", "Document Object list", "OADP", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tNO, BoFldSubTypes.st_None, false, "");
                //////B1Helper.AddField("ITN_SMSACTIVE", "Activate SMS", "ADP1", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tNO, BoFldSubTypes.st_None, false, "");
                //////#endregion

                //////#region SMSCONFIGURATION
                //////B1Helper.AddTable("ITN_SMSCONFG", "SMS Configuration Setup", BoUTBTableType.bott_NoObjectAutoIncrement);
                //////B1Helper.AddField("ITN_SPAPI", "SMS POST API", "ITN_SMSCONFG", BoFieldTypes.db_Alpha, 200, BoYesNoEnum.tNO, BoFldSubTypes.st_None, true, "");
                //////B1Helper.AddField("ITN_CRDAPI", "SMS CREDIT API ", "ITN_SMSCONFG", BoFieldTypes.db_Alpha, 200, BoYesNoEnum.tNO, BoFldSubTypes.st_None, true, "");
                //////B1Helper.AddField("ITN_ENABLE", "IsEnable", "ITN_SMSCONFG", BoFieldTypes.db_Alpha, 1, BoYesNoEnum.tYES, BoFldSubTypes.st_None, true, "");
                //////B1Helper.AddField("From", "From", "ITN_SMSCONFG", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tYES, BoFldSubTypes.st_None, true, "");
                //////B1Helper.AddField("Token", "Token", "ITN_SMSCONFG", BoFieldTypes.db_Alpha,200, BoYesNoEnum.tYES, BoFldSubTypes.st_None, true, "");
                
                //////#endregion


                //B1Helper.RemoveField("OADP", 0);
                //B1Helper.RemoveField("OADP", 2);
                //B1Helper.RemoveField("OADP", 3);

               


                //////#region LIST OF DOCUMENT OBJECTS FOR SMS
                //////B1Helper.AddTable("ITN_ODLS", "Document Objects", BoUTBTableType.bott_MasterData);
                //////Array.Resize(ref FormColumn, 2);
                //////FormColumn[0] = "Code";
                //////FormColumn[1] = "Name";
                //////B1Helper.CreateUdo("ODLS", "Document Objects", "ITN_ODLS", "M", "Y", FormColumn, null);
                //////#endregion

                //////#region SMS Details Setup
                //////B1Helper.AddTable("ITN_OSMS", "SMS Details Setup", BoUTBTableType.bott_Document);

                //////B1Helper.AddField("ITN_OBJLST", "Document Object List Code", "ITN_OSMS", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tNO, BoFldSubTypes.st_None, true, "");
                //////B1Helper.AddField("ITN_OBJLNAM", "Document Object List Name", "ITN_OSMS", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tNO, BoFldSubTypes.st_None, true, "");

                ////////Child table
                //////B1Helper.AddTable("ITN_SMS1", "SMS Details Setup CH1", BoUTBTableType.bott_DocumentLines);

                ////////Child Fields.
                //////B1Helper.AddField("ITN_CODE", "Field Code", "ITN_SMS1", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tNO, BoFldSubTypes.st_None, true);
                //////B1Helper.AddField("ITN_NAME", "Field Name", "ITN_SMS1", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tNO, BoFldSubTypes.st_None, true);
                //////Array.Resize(ref FormColumn, 0);
                //////Array.Resize(ref ChildTable, 1);
                //////ChildTable[0] = "ITN_SMS1";
                //////B1Helper.CreateUdo("OSMS", "SMS Details Setup", "ITN_OSMS", "D", "N", FormColumn, ChildTable);
                //////#endregion
                ...
                //        B1Helper.AddTable("ITN_OITN", "Item Codes", BoUTBTableType.bott_Document);
                //        B1Helper.AddField("ITEMNAME", "Item Name", "ITN_OITM", BoFieldTypes.db_Alpha, 100, BoYesNoEnum.tYES, BoFldSubTypes.st_None, true, "");
                //        B1Helper.AddField("ITEMCODE", "Item Code", "ITN_OITM", BoFieldTypes.db_Alpha, 20, BoYesNoEnum.tYES, BoFldSubTypes.st_None, true, "");

                //        // Array.Resize(ref FindColumn, 1);
                //        Array.Resize(ref FormColumn, 3);
                //        FormColumn[0] = "DocEntry";
                //        FormColumn[1] = "U_ITEMNAME";
                //        FormColumn[2] = "U_ITEMCODE";
                //        B1Helper.CreateUdo("ITN_OITM", "Item Codes", "ITN_OITM", "D", "Y", FormColumn, null);

                //        #endregion

                //        //B1Helper.DiCompany.StartTransaction();
                //        #region OADM
                //        ITNepal.MainLibrary.SAPB1.B1Helper.AddField("LOCSTATS", "Letter Of Credit", "OADM", BoFieldTypes.db_Alpha, 10, BoYesNoEnum.tNO, BoFldSubTypes.st_None, false, "");
                ...
                //        //GatePass table 
                //        ITNepal.MainLibrary.SAPB1.B1Helper.AddTable("ITN_OGTP", "Gate entry", BoUTBTableType.bott_Document);
                ...
                //        //LOC CHILD1 TABLE
                //        ITNepal.MainLibrary.SAPB1.B1Helper.AddTable("ITN_LOC1", "Letter of Credit CH1", BoUTBTableType.bott_DocumentLines);
                ...
                //        //LOC CHILD2 TABLE
                //        ITNepal.MainLibrary.SAPB1.B1Helper.AddTable("ITN_LOC2", "Letter of Credit CH2", BoUTBTableType.bott_DocumentLines);
                ...
                //        //LOC CHILD3 TABLE
                //        ITNepal.MainLibrary.SAPB1.B1Helper.AddTable("ITN_LOC3", "Letter of Credit CH3", BoUTBTableType.bott_DocumentLines);
