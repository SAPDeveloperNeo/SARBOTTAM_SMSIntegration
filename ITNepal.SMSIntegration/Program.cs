...
using ITNepal.SMSIntegration.Helpers;
using SAPbobsCOM;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Application.SBO_Application.StatusBar.SetSystemMessage("ITNepal SMS Integration Add-on installed successfully.", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
                oApp.Run();
